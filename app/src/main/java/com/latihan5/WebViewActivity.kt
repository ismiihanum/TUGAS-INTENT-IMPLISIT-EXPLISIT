...
import kotlinx.android.synthetic.main.activity_implisit_intent.view.*
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.activity_webview.*

class WebViewActivity : AppCompatActivity() {
//    private val URL = "http://informatika.upgris.ac.id"
    private val URL = "https://ismiihanum.github.io/SIG-JAMAAH-HAJI-KAB-SEMARANG-2017/"
...
//                Toast.makeText(this, "", Toast.LENGTH_LONG).sh
    ...
    override fun onResume() {
        ...
        if (isAlreadyCreated && !isNetworkAvailable()) {
            ...
            showErrorDialog(
                "Error", "No internet connection. Please check your connection.", this
            )
        }
    }
